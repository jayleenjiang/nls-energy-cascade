...
const double T_burnin = 500.0;  // time to reach steady state
...
struct SimulationResult {
    ...
    double measurement_time;  // time spent measuring after burn in
};
...
void run_simulation(int n, int case_num, double Tn, int flux_mode, std::mt19937& rng, SimulationResult& result) {
    ...
    bool measuring = false;  // start measure after burn in
    ...
    while(current_time < T_final)
    {
        ...
        // accumulate after burn in period
