...
Generated: `2026-06-19T17:53:20.399373+00:00`
...
| submission_bundle_manifest | PASS_WITH_LOCAL_RAW_DATA_LIMITATION | local_raw_dependency_count=44, missing_release_files=0, release_directory_count=1, release_file_count=50, status=PASS_WITH_LOCAL_RAW_DATA_LIMITATION, untracked_local_raw_dependencies=44, untracked_release_files=0 |
...
| `availability_path_audit` | 0 | 0.143 |
| `manuscript_claim_audit` | 0 | 0.031 |
| `submission_bundle_manifest_initial` | 0 | 0.58 |
| `raw_data_archive_manifest` | 0 | 0.114 |
| `submission_bundle_manifest_final` | 0 | 0.549 |
