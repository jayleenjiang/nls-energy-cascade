...
Generated: `2026-06-20T19:29:48.179734+00:00`
...
| submission_source_bundle | PASS | directory_tracked_file_count=174, excluded_self_referential_count=6, included_file_count=264, included_total_bytes=4489780, local_raw_dependency_count=44, manifest_release_directories=1, manifest_release_file_records=95, missing_file_count=0 |
...
| `compiled_pdf_artifact_audit` | 0 | 0.028 |
| `availability_path_audit` | 0 | 0.158 |
| `manuscript_claim_audit` | 0 | 0.041 |
| `reference_integrity_audit` | 0 | 0.027 |
| `author_submission_fields_audit` | 0 | 0.023 |
| `submission_bundle_manifest_initial` | 0 | 0.685 |
| `raw_data_archive_manifest` | 0 | 0.219 |
