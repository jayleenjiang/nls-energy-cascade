...
Generated: `2026-06-20T13:00:16.149249+00:00`
...
| submission_source_bundle | PASS | directory_tracked_file_count=113, excluded_self_referential_count=6, included_file_count=172, included_total_bytes=3559239, local_raw_dependency_count=44, manifest_release_directories=1, manifest_release_file_records=64, missing_file_count=0 |
...
| `manuscript_claim_audit` | 0 | 0.035 |
| `reference_integrity_audit` | 0 | 0.027 |
| `submission_bundle_manifest_initial` | 0 | 0.575 |
| `raw_data_archive_manifest` | 0 | 0.142 |
| `submission_bundle_manifest_final` | 0 | 0.579 |
| `submission_source_bundle` | 0 | 0.237 |
