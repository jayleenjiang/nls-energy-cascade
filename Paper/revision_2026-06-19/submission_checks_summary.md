...
Generated: `2026-06-22T05:24:53.346557+00:00`
...
| journal_upload_package | PASS | contains_raw_data_archive=False, package_file_count=14, package_total_bytes=5466067 |
...
| `manuscript_claim_audit` | 0 | 0.062 |
| `reference_integrity_audit` | 0 | 0.028 |
| `author_submission_fields_audit` | 0 | 0.022 |
| `submission_bundle_manifest_initial` | 0 | 0.876 |
| `raw_data_archive_manifest` | 0 | 0.157 |
| `submission_bundle_manifest_final` | 0 | 0.836 |
| `submission_metadata_consistency_audit` | 0 | 0.028 |
| `submission_bundle_manifest_post_metadata` | 0 | 0.821 |
| `submission_source_bundle` | 0 | 0.462 |
| `siads_cover_letter_template` | 0 | 0.08 |
| `journal_upload_package` | 0 | 0.124 |
