...
Generated: `2026-06-20T20:14:24.375750+00:00`
...
| submission_bundle_manifest | PASS_WITH_LOCAL_RAW_DATA_LIMITATION | local_raw_dependency_count=44, missing_release_files=0, release_directory_count=1, release_file_count=100, status=PASS_WITH_LOCAL_RAW_DATA_LIMITATION, untracked_local_raw_dependencies=44, untracked_release_files=0 |
| submission_metadata_consistency_audit | PASS | checked_documents=9, failed_checks=0, predicted_source_bundle_included_count=269, release_file_count=100, total_checks=21 |
| submission_source_bundle | PASS | directory_tracked_file_count=174, excluded_self_referential_count=6, included_file_count=269, included_total_bytes=4568480, local_raw_dependency_count=44, manifest_release_directories=1, manifest_release_file_records=100, missing_file_count=0 |
| journal_upload_package | PASS | contains_raw_data_archive=False, package_file_count=11, package_total_bytes=4467044 |
...
| `siads_latex_compile` | 0 | 0.049 |
| `compiled_pdf_artifact_audit` | 0 | 0.029 |
| `availability_path_audit` | 0 | 0.144 |
| `manuscript_claim_audit` | 0 | 0.042 |
| `reference_integrity_audit` | 0 | 0.026 |
| `author_submission_fields_audit` | 0 | 0.022 |
| `submission_bundle_manifest_initial` | 0 | 0.696 |
| `raw_data_archive_manifest` | 0 | 0.205 |
| `submission_bundle_manifest_final` | 0 | 0.712 |
| `submission_metadata_consistency_audit` | 0 | 0.027 |
| `submission_bundle_manifest_post_metadata` | 0 | 0.696 |
| `submission_source_bundle` | 0 | 0.325 |
| `journal_upload_package` | 0 | 0.11 |
