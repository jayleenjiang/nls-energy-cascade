...
Generated: `2026-06-20T07:00:30.643846+00:00`
...
| submission_source_bundle | PASS | directory_tracked_file_count=113, excluded_self_referential_count=6, included_file_count=170, included_total_bytes=3477760, local_raw_dependency_count=44, manifest_release_directories=1, manifest_release_file_records=62, missing_file_count=0 |
...
| `availability_path_audit` | 0 | 0.177 |
| `manuscript_claim_audit` | 0 | 0.034 |
| `reference_integrity_audit` | 0 | 0.028 |
| `submission_bundle_manifest_initial` | 0 | 0.57 |
| `raw_data_archive_manifest` | 0 | 0.148 |
| `submission_bundle_manifest_final` | 0 | 0.644 |
