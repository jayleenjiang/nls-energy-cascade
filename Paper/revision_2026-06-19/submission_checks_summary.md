...
Generated: `2026-06-19T17:50:24.247189+00:00`
...
| submission_bundle_manifest | PASS_WITH_LOCAL_RAW_DATA_LIMITATION | local_raw_dependency_count=44, missing_release_files=0, release_directory_count=1, release_file_count=49, status=PASS_WITH_LOCAL_RAW_DATA_LIMITATION, untracked_local_raw_dependencies=44, untracked_release_files=0 |
...
| `availability_path_audit` | 0 | 0.14 |
| `manuscript_claim_audit` | 0 | 0.034 |
| `submission_bundle_manifest_initial` | 0 | 0.56 |
| `raw_data_archive_manifest` | 0 | 0.179 |
| `submission_bundle_manifest_final` | 0 | 0.534 |
