...
Generated: `2026-06-21T02:58:47.520073+00:00`
...
| manuscript_claim_audit | PASS | total_claims=21, verified=21, failed=0 |
...
| submission_source_bundle | PASS | directory_tracked_file_count=200, excluded_self_referential_count=6, included_file_count=316, included_total_bytes=6152593, local_raw_dependency_count=44, manifest_release_directories=1, manifest_release_file_records=121, missing_file_count=0 |
| siads_cover_letter_template | PASS | template_not_final=True, size_bytes=118094, issues=0 |
| journal_upload_package | PASS | contains_raw_data_archive=False, package_file_count=14, package_total_bytes=5344985 |

## Command results

| Command | Return code | Duration (s) |
|---|---:|---:|
| `latex_compile` | 0 | 0.067 |
| `siads_latex_compile` | 0 | 0.055 |
| `compiled_pdf_artifact_audit` | 0 | 0.04 |
| `availability_path_audit` | 0 | 0.173 |
| `manuscript_claim_audit` | 0 | 0.053 |
| `reference_integrity_audit` | 0 | 0.03 |
| `author_submission_fields_audit` | 0 | 0.024 |
| `submission_bundle_manifest_initial` | 0 | 1.19 |
| `raw_data_archive_manifest` | 0 | 0.192 |
| `submission_bundle_manifest_final` | 0 | 0.844 |
| `submission_metadata_consistency_audit` | 0 | 0.03 |
| `submission_bundle_manifest_post_metadata` | 0 | 0.853 |
| `submission_source_bundle` | 0 | 0.486 |
| `siads_cover_letter_template` | 0 | 0.083 |
