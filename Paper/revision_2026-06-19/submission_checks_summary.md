...
Generated: `2026-06-19T18:01:09.668273+00:00`
...
| submission_bundle_manifest | PASS_WITH_LOCAL_RAW_DATA_LIMITATION | local_raw_dependency_count=44, missing_release_files=0, release_directory_count=1, release_file_count=51, status=PASS_WITH_LOCAL_RAW_DATA_LIMITATION, untracked_local_raw_dependencies=44, untracked_release_files=0 |
...
| `submission_bundle_manifest_initial` | 0 | 0.572 |
| `raw_data_archive_manifest` | 0 | 0.151 |
| `submission_bundle_manifest_final` | 0 | 0.509 |
