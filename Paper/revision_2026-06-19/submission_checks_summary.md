...
Generated: `2026-06-20T18:03:42.785417+00:00`
...
| submission_source_bundle | PASS | directory_tracked_file_count=161, excluded_self_referential_count=6, included_file_count=231, included_total_bytes=3761049, local_raw_dependency_count=44, manifest_release_directories=1, manifest_release_file_records=75, missing_file_count=0 |
...
| `availability_path_audit` | 0 | 0.153 |
...
| `submission_bundle_manifest_final` | 0 | 0.582 |
| `submission_source_bundle` | 0 | 0.269 |
