...
| Check canonical finite-time current distribution | `report_assets/canonical_flux_distribution.pdf`; `report_assets/canonical_flux_distribution_tail_summary.csv`; `manuscript_claim_audit.md` | Canonical simulator distribution figure and source-traced upper-middle-tail survival-fit summary used descriptively in the appendix. |
...
| Check SIADS policy refresh | `target_journal_policy_refresh_2026-06-22.md`; `siads_first_submission_packet_2026-06-20.md` | Official SIAM/SIADS policy refresh for the recommended first target, including AI-use disclosure, line-number/SIAM-macro handling, supplementary-material index, and raw-data release implications. |
