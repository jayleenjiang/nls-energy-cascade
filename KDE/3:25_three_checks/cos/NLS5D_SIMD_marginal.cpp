...
#pragma omp parallel num_threads(N_thread)
    ...
    // === Cos fitting: log(PDF) = C - a1*cos(theta1) - a3*cos(theta3) ===
    {
        ...
        cout << endl;
        cout << "=== Cos Fit Results (better!) ===" << endl;
        cout << "log(PDF) ~ C - a1*cos(theta1) - a3*cos(theta3)" << endl;
        cout << "a1 = " << a1_cos << endl;
        cout << "a3 = " << a3_cos << endl;
        cout << endl;
        cout << "a1 * T  = " << a1_cos * T_eq << endl;
        cout << "<I1*I2> = " << mean_I1I2 << endl;
        cout << "Ratio a1*T / <I1*I2> = " << (a1_cos * T_eq) / mean_I1I2 << endl;
        cout << endl;
        cout << "a3 * T  = " << a3_cos * T_eq << endl;
        cout << "<I2*I3> = " << mean_I2I3 << endl;
        cout << "Ratio a3*T / <I2*I3> = " << (a3_cos * T_eq) / mean_I2I3 << endl;
    }
