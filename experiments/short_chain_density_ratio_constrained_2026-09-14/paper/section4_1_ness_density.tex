...
combines the stationary Fokker--Planck residual with moment constraints.  We
...
criteria.  The effective-sample fractions are 0.9160--0.9178, the median
absolute relative stationary-equation residuals are 0.08875--0.09501, the
largest of the twelve stream-bootstrap moment discrepancies is
\(1.44\) standard errors, and the largest marginal total-variation distance is
...
0.0242.  More importantly, the centered fine/coarse ensemble log-density RMS
is 0.02426 on the fine support and 0.02427 on the coarse support, well below
