...
analyze_n20() {
  python3 "$repo_root/flux/analyze_long_chain_ft.py" \
    ...
    --output-dir "$analysis/n20_controls" --horizons 20 30 40 50 60
...
analyze_n30_population() {
  python3 "$repo_root/flux/analyze_long_chain_ft.py" \
    ...
    --output-dir "$analysis/n30_population" --horizons 20 30 40 50 60
}
...
analyze_n30_controls() {
  python3 "$repo_root/flux/analyze_long_chain_ft.py" \
    ...
    --output-dir "$analysis/n30_controls" --horizons 20 30 40 50 60
  python3 "$repo_root/flux/analyze_long_chain_ft_controls.py" \
